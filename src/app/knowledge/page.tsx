    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "16px", boxSizing: "border-box", fontFamily: "sans-serif" }}>
        ...
        <div style={{ marginTop: "12px", display: "flex", flexWrap: "wrap", gap: "6px", justifyContent: "center" }}>
          <button
            ...
            style={{ 
              ...
              cursor: "pointer",
              fontSize: "0.85rem",
              backgroundColor: selectedSubject === "all" ? "#1e4ed8" : "#fff", 
              color: selectedSubject === "all" ? "#fff" : "#475569",
              fontWeight: selectedSubject === "all" ? "bold" : "normal"
            }}
          >
            すべて
          </button>
          {(["math", "japanese", "science", "society"] as const).map((sub) => (
            <button
              ...
              style={{ 
                ...
                cursor: "pointer",
                fontSize: "0.85rem",
                backgroundColor: selectedSubject === sub ? "#1e4ed8" : "#fff", 
      ...
      {isLoading ? (
        ...
        <div style={{ textAlign: "center", padding: "40px" }}>
          <p style={{ color: "#94a3b8" }}>あてはまるナレッジカードが見つからないよ。</p>
        </div>
      ) : (
      ...
      {selectedCard && (
        ...
        >
          ...
          >
            ...
            {/* 2. この問題の本質 ＆ 3. 似た問題との違い */}
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "20px" }}>
              <div style={{ border: "1px solid #e5e7eb", padding: "12px 14px", borderRadius: "12px", backgroundColor: "#fff" }}>
                <h4 style={{ margin: "0 0 4px 0", color: "#111827", fontSize: "0.95rem", display: "flex", alignItems: "center", gap: "4px" }}>💡 この問題の本質</h4>
                <p style={{ margin: 0, fontSize: "0.88rem", color: "#4b5563", lineHeight: "1.4" }}>{selectedCard.content.essence}</p>
              </div>
              <div style={{ border: "1px solid #e5e7eb", padding: "12px 14px", borderRadius: "12px", backgroundColor: "#fff" }}>
                <h4 style={{ margin: "0 0 4px 0", color: "#111827", fontSize: "0.95rem", display: "flex", alignItems: "center", gap: "4px" }}>🔍 似たパターンとの違い</h4>
            ...
            <div style={{ backgroundColor: "#fffbeb", padding: "14px", borderRadius: "14px", marginBottom: "20px", border: "1px solid #fef3c7", borderLeft: "5px solid #d97706" }}>
              <h4 style={{ margin: "0 0 6px 0", color: "#b45309", fontSize: "0.95rem", fontWeight: "bold" }}>
                ⚡ ここが運命の分かれ道！
              </h4>
            ...
            <div style={{ 
              ...
              <span style={{ fontSize: "0.75rem", fontWeight: "bold", color: "#4338ca", display: "block", marginBottom: "4px", letterSpacing: "0.05em" }}>⚔️ 単元を無双する最強の武器</span>
            ...
            {/* 7. ロジックステップ */}
            <div style={{ marginBottom: "24px" }}>
              <h4 style={{ margin: "0 0 12px 0", color: "#374151", fontSize: "1rem", borderBottom: "2px solid #e5e7eb", paddingBottom: "6px" }}>
                🪜 解法のロジックステップ
              </h4>
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                {selectedCard.content.logicalSteps?.map((stepStr, idx) => {
