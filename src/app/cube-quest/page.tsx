...
const getPatterns = (): Record<string, FaceDef[]> => ({
  ...
  "1-3-2-a (1が上)": [
    ...
    { id: "c2", color: COLORS.t, pos: [0, 1, 0], pivot: [0, 0.5, 0], axis: "Y", sign: -1, parent: "c1" }, // c1-c2の辺
    { id: "c3", color: COLORS.b, pos: [0, -1, 0], pivot: [0, -0.5, 0], axis: "Y", sign: -1, parent: "c1" }, // c1-c3の辺
    ...
    { id: "r2", color: COLORS.bk, pos: [1, 2, 0], pivot: [1, 1.5, 0], axis: "Y", sign: -1, parent: "r1" } // r1-r2の辺
  ],
  "1-3-2-b (1が中)": [
    { id: "c1", color: COLORS.f, pos: [0, 0, 0], pivot: [0, 0, 0], axis: "X", sign: 0 },
