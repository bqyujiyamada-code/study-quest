  ...
  return (
    <main className="main-container">
      ...
      <style jsx>{`
        ...
        .history-nav-link { display: block; text-align: center; margin-top: 12px; font-size: 12px; font-weight: 900; color: #8ABBA6; text-decoration: none; }
        ...
        .lvl-up-title { font-size: 38px; font-weight: 900; margin: 0; background: linear-gradient(to bottom, #FF4D6D, #FFB703); -webkit-background-clip: text; -webkit-text-fill-color: transparent; filter: drop-shadow(2px 2px 0 white); animation: rainbow 2s infinite linear; }
        .new-rank-name { font-size: 20px; font-weight: 900; color: #2D5A47; margin-top: 5px; }
        .rate-up-badge { background: #FFF0F3; border: 2px solid #FF4D6D; color: #FF4D6D; padding: 8px 15px; border-radius: 20px; font-weight: 900; display: inline-block; margin-top: 10px; font-size: 14px; }
        .rate-up-badge span { font-size: 18px; text-decoration: underline; }
        .bonus-badge { background: linear-gradient(90deg, #FF4D6D, #FFB703); color: white; font-size: 12px; font-weight: 900; padding: 5px 15px; border-radius: 15px; display: inline-block; margin-bottom: 10px; animation: pulse 1s infinite; }
